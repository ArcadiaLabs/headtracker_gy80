...
#define SCALING_FACTOR 14.286     // Scaling factor - used when converting to angle
...
void trackerOutput()
{
  Serial1.print(tiltAngleLP - tiltStart + 90);
  Serial1.print(",");
  Serial1.print(rollAngleLP - rollStart + 90);
  Serial1.print(",");  
  Serial1.println(panAngleLP + 180);
}

void calMagOutput()
{
    Serial1.print((int)magRaw[0] + 3000);
    Serial1.print(",");
    Serial1.print((int)magRaw[1] + 3000);
    Serial1.print(",");    
    Serial1.println((int)magRaw[2] + 3000);   
}

void calAccOutput()
{
    Serial1.print((int)accRaw[0] + 3000);  
    Serial1.print(",");          
    Serial1.print((int)accRaw[1] + 3000);  
    Serial1.print(",");              
    Serial1.println((int)accRaw[2] + 3000);  
}
...
void calMagAccOutput()
{
    ...
    Serial1.print((int)magRaw[1] + 3000);
    Serial1.print(",");    
    Serial1.print((int)magRaw[2] + 3000);
    Serial1.print(","); 
    Serial1.print((int)accRaw[0] + 3000);  
    Serial1.print(",");          
    Serial1.print((int)accRaw[1] + 3000);  
...
void UpdateSensors()
{
    ...
    gyroRaw[0] = raw.XAxis;
    gyroRaw[1] = raw.YAxis*-1;
    gyroRaw[2] = raw.ZAxis*-1;
...
#if (DEBUG)
    Serial1.print("Mag cal:");
    Serial1.print(magNegOff[0] - magPosOff[0]);
    Serial1.print(",");   
    Serial1.print(magNegOff[1] - magPosOff[1]);
    Serial1.print(",");      
    Serial1.print(magNegOff[2] - magPosOff[2]);
   
    Serial1.print(",");      
    Serial1.print(magGain[0]);
    Serial1.print(",");   
    Serial1.print(magGain[1]);
    Serial1.print(",");      
    Serial1.println(magGain[2]);   
   
   
    Serial1.print("Mag offset:");
...
//#if (DEBUG)    
//    Serial1.print("ITG3205: ");
//    Serial1.print(sensorBuffer[0]);
//#endif 
...
#if (DEBUG)     
    Serial1.print("    HMC: ");
    Serial1.println(sensorBuffer[0]); 
#endif  
...
{ 
   ...
   Serial1.print("ADXL345 ID: ");
   Serial1.println((int)ADXL345_ID); 
   Serial1.print("ITG3205 ID: ");
   Serial1.println((int)ITG3205_ID); 
   Serial1.print("HMC ID: ");
   Serial1.println((int)HMC_ID);   
}
...
{
    Serial1.print("RAW: ");  
    Serial1.print(accRaw[0]);  
    Serial1.print(" ");          
    Serial1.print(accRaw[1]);  
    Serial1.print(" ");              
    Serial1.print(accRaw[2]);  

    Serial1.print("\t G: ");        
    Serial1.print(accG[0]); 
    Serial1.print(" ");    
    Serial1.print(accG[1]); 
    Serial1.print(" "); 
    Serial1.print(accG[2]); 

    Serial1.print("\t Ang: ");        
    Serial1.print(accAngle[0]); 
    Serial1.print(" ");    
    Serial1.print(accAngle[1]); 
    Serial1.print(" "); 
    Serial1.println(accAngle[2]);
}
...
{  
    ...
    Serial1.print(",");              
    Serial1.print(gyroRaw[2]);   

    Serial1.print(",");        
    Serial1.print(angle[0]);  
    Serial1.print(",");          
    Serial1.print(angle[1]);  
    Serial1.print(",");              
    Serial1.println(angle[2]);
}

void testMagOutput()
{
    Serial1.print(magRaw[0]);
    Serial1.print(",");
    Serial1.print(magRaw[1]);
    Serial1.print(",");    
    Serial1.print(magRaw[2]);    

    Serial1.print(",");              
    Serial1.print(magAngle[0]);  
    Serial1.print(",");          
    Serial1.print(magAngle[1]);  
    Serial1.print(",");              
    Serial1.println(magAngle[2]);      
}
...
{ 
    Serial1.print(angle[1]);
    Serial1.print(",");          
    Serial1.print(accAngle[0]-tiltStart);
    Serial1.print(",");          
    Serial1.println(tiltAngle-tiltStart);
}
...
void testRollOutput()
{
    Serial1.print(angle[0]);
    Serial1.print(",");          
    Serial1.print(accAngle[1]-rollStart);
    Serial1.print(",");          
    Serial1.println(rollAngle-rollStart);  
}

void testPanOutput()
{
    Serial1.print(angle[2]);
    Serial1.print(",");                  
    Serial1.print(magAngle[2]);
    Serial1.print(",");                  
    Serial1.println(panAngle);
}
...
{  
  ...
  Serial1.print(angle[1]);
  Serial1.print(",");          
  Serial1.print(accAngle[0]-90);
  Serial1.print(",");          
  Serial1.print(tiltAngle-90);
  Serial1.print(",");      
  
    // y
  Serial1.print(angle[0]);
  Serial1.print(",");          
  Serial1.print(accAngle[1]-90);
  Serial1.print(",");          
  Serial1.print(rollAngle-90);  
  Serial1.print(",");     
    
    // z
  Serial1.print(angle[2]);
  Serial1.print(",");                  
  Serial1.print(magAngle[2]-panStart);
  Serial1.print(",");                  
  Serial1.println(panAngle);
}
