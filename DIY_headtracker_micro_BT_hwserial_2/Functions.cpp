...
{
#if (DEBUG)    
    Serial1.println("PWM interrupt initialized");
#endif
...
{  
#if (DEBUG)    
    Serial1.println("Timer interrupt initialized");
#endif
 ...
 */
    ...
    if (read_sensors == 1)
    {
        ...
        if (time_out > 10)
        {
            //Serial1.println("Timing problem!!!"); 
            time_out = 0;  
        }
    }
#endif
